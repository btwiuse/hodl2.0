...
if (this.address) {
  ...
  { !connected  &&  <a className="cta-btn align-middle" href="#" data-toggle="modal" data-target="#exampleModalCenter">Connet wallet</a>   } 
  { connected  && <div> <a className="cta-btn align-middle" href="#" >Swap </a>   
  
      <div >
      <br></br>   
         <h6 style={{ color: 'white' }}>HODL V1 Balance {this.state.hodl1balance}</h6>
       </div>  
  </div>
  } 
