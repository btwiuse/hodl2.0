   ...
   <div className="container">
     <div className="row">
       <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
         <h1>EARN MONEY BY HOLDING </h1> <br></br>
...
<p></p>
<p>Making Money Was Never This Simple!</p>
</h2>
...
<br/> EARN $BNB by hodling the $HODL Token ! */}
         ...
         <div className="d-lg-flex">
           ...
           <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x58980C72b67e1819356ba5a3Ee352dBb7e11Cd08" className="btn-get-started scrollto " target="_blank">Buy Now</a>
     ...
     <div className="row pt-5 pb-3 price_coin">
       ...
       <div className="d-lg-flex abc">
           ...
           <a  className="btn-get-started scrollto ">Total BNB in reward pool
             <br/>
