...
{ comp2 && <div>            <h5> Your Reward     Share</h5>
                            ...
                            <h5></h5>
                            <h6>Making Money Was Never This Simple!</h6>
                            <br/>
                            <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x58980C72b67e1819356ba5a3Ee352dBb7e11Cd08" className="btn-get-started scrollto dashboard" target="_blank">Buy $HODL</a>
                        </div>
                    </div>
                </div>
            </div>
